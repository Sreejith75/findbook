...
**Updated `tests\FindBook.FunctionalTests\FindBook.FunctionalTests.csproj`:**
- Removed: `Microsoft.EntityFrameworkCore.InMemory`
- Added: `Testcontainers` and `Testcontainers.MsSql`

### 2. CustomWebApplicationFactory

**File:** `tests\FindBook.FunctionalTests\CustomWebApplicationFactory.cs`
...
```bash
dotnet test tests\FindBook.FunctionalTests\FindBook.FunctionalTests.csproj
```
